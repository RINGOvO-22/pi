...
- [@earendil-works/pi-ai](#earendil-workspi-ai)
  ...
  - [Browser Usage](#browser-usage)
    ...
    - [Environment Variables (Node.js only)](#environment-variables-nodejs-only)
  ...
  - [Development](#development)
    - [Adding a New Provider](#adding-a-new-provider)
      - [1. Core Types (`src/types.ts`)](#1-core-types-srctypests)
      - [2. Provider Implementation (`src/providers/`)](#2-provider-implementation-srcproviders)
      - [3. API Registry Integration (`src/providers/register-builtins.ts`)](#3-api-registry-integration-srcprovidersregister-builtinsts)
      - [4. Model Generation (`scripts/generate-models.ts`)](#4-model-generation-scriptsgenerate-modelsts)
      - [5. Tests (`test/`)](#5-tests-test)
      - [6. Coding Agent Integration (`../coding-agent/`)](#6-coding-agent-integration-coding-agent)
