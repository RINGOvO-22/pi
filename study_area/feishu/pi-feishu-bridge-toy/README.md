...
```bash
cd study_area/feishu/pi-feishu-bridge-toy
conda create -n pi-feishu-bridge-toy python=3.11 -y
conda activate pi-feishu-bridge-toy
...
如果你想用更短的环境名，也可以把 `pi-feishu-bridge-toy` 换成 `feishu-pi`。
